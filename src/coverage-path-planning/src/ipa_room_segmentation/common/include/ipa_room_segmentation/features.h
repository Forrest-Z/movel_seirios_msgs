...
public:
  ...
  void get_features(const std::vector<double>& beams, const std::vector<double>& angles, cv::Point point,
                    cv::Mat& features);
  ...
  std::vector<cv::Point> calc_polygonal_approx(const std::vector<double>&, const std::vector<double>&,
                                               cv::Point location);
