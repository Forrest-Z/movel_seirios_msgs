...
LaserScannerRaycasting::LaserScannerRaycasting() : precomputed_cos_(360), precomputed_sin_(360)
{
...
void LaserScannerRaycasting::bresenham_raycasting(const cv::Mat& map, const cv::Point& location,
