...
int main(int argc, char** argv)
{
  ...
  {
    // std::string image_filename = ros::package::getPath("ipa_room_segmentation") + "/common/files/test_maps/" +
    // map_names[image_index];
    std::string image_filename = "/home/movel/sim_map2.png";
    ...
    DynamicReconfigureClient drc_seg(nh, "/room_segmentation/room_segmentation_server/set_parameters",
    ...
    goal_seg.map_origin.position.x = -100;  // 0
    goal_seg.map_origin.position.y = -100;  // 0
    ...
    DynamicReconfigureClient drc_seq(nh, "/room_sequence_planning/room_sequence_planning_server/set_parameters",
