...
int main(int argc, char** argv)
{
  ...
  for (int number_of_nodes = 10; number_of_nodes <= 210; number_of_nodes += 20)
  {
    ...
    distance_matrix_computation.constructDistanceMatrix(distance_matrix, map, nodes, downsampling, robot_radius,
                                                        map_resolution, planner);
    ...
    std::cout << "number of nodes in the paths: " << nearest_order.size() << " " << genetic_order.size() << " "
              << concorde_order.size() << std::endl;
    ...
    std::cout << "doing last paths. Indexes: " << nearest_order.back() << " " << genetic_order.back() << " "
              << concorde_order.back() << std::endl;
    ...
    pathlength_output << "number of nodes: " << number_of_nodes << std::endl
                      << nearest_pathlength << std::endl
                      << genetic_pathlength << std::endl
                      << concorde_pathlength << std::endl
                      << std::endl;
    times_output << "number of nodes: " << number_of_nodes << std::endl
                 << nearest_time << std::endl
                 << genetic_time << std::endl
                 << concorde_time << std::endl
                 << std::endl;
  }
