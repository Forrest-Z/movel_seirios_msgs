...
public:
  ...
  // and
  // the columns to which node to go. If the path between nodes doesn't exist or the node to go to is the same as the
  // one to
  ...
  // maximum size clique of reachable points
  // cleaned_index_to_original_index_mapping --> maps the indices of the cleaned distance_matrix to the original indices
  // of the original distance_matrix
