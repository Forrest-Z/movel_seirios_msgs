...
bool operator==(const ::pr2_mechanism_controllers::TrackLinkCmd_<ContainerAllocator1> & lhs, const ::pr2_mechanism_controllers::TrackLinkCmd_<ContainerAllocator2> & rhs)
{
