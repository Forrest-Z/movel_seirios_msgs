...
bool operator==(const ::cob_msgs::PowerState_<ContainerAllocator1> & lhs, const ::cob_msgs::PowerState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.relative_remaining_capacity == rhs.relative_remaining_capacity &&
