...
bool operator==(const ::cob_msgs::DashboardState_<ContainerAllocator1> & lhs, const ::cob_msgs::DashboardState_<ContainerAllocator2> & rhs)
{
  return lhs.diagnostics_toplevel_state == rhs.diagnostics_toplevel_state &&
    lhs.power_state == rhs.power_state &&
    lhs.emergency_stop_state == rhs.emergency_stop_state;
}
