...
"""autogenerated by genpy from cob_actions/SetFloatActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SetFloatActionFeedback(genpy.Message):
  _md5sum = "c174906940145c775f10875f0919664b"
  _type = "cob_actions/SetFloatActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_actions/SetFloatFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetFloatActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_actions.msg.SetFloatFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_actions.msg.SetFloatFeedback()
