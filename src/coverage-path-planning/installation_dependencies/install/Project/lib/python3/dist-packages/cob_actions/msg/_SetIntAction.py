...
"""autogenerated by genpy from cob_actions/SetIntAction.msg. Do not edit."""
import codecs
import sys
...
class SetIntAction(genpy.Message):
  _md5sum = "b11d6f491d05b51e8d57714e43711737"
  _type = "cob_actions/SetIntAction"
...
"""
  ...
  _slot_types = ['cob_actions/SetIntActionGoal','cob_actions/SetIntActionResult','cob_actions/SetIntActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetIntAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cob_actions.msg.SetIntActionGoal()
      if self.action_result is None:
        self.action_result = cob_actions.msg.SetIntActionResult()
      if self.action_feedback is None:
        self.action_feedback = cob_actions.msg.SetIntActionFeedback()
    else:
      self.action_goal = cob_actions.msg.SetIntActionGoal()
      self.action_result = cob_actions.msg.SetIntActionResult()
      self.action_feedback = cob_actions.msg.SetIntActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_goal.goal.data, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.data, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
