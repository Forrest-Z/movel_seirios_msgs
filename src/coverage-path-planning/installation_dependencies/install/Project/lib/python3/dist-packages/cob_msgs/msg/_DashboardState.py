...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.diagnostics_toplevel_state.level
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.diagnostics_toplevel_state.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.diagnostics_toplevel_state.message = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.diagnostics_toplevel_state.hardware_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.power_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
