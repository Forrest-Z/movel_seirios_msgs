...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.known_objects.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v33.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
      ...
      if python3:
        self.action_feedback.feedback.currentStep.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v103.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
