...
class BaseControllerState2 {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.joint_error, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BaseControllerState2(null);
    ...
    data.joint_error = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.joint_error.length;
  ...
  static Resolve(msg) {
    ...
    const resolved = new BaseControllerState2(null);
...
module.exports = BaseControllerState2;
