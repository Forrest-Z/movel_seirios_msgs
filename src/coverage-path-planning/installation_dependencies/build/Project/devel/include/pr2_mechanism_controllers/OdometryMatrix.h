...
bool operator==(const ::pr2_mechanism_controllers::OdometryMatrix_<ContainerAllocator1> & lhs, const ::pr2_mechanism_controllers::OdometryMatrix_<ContainerAllocator2> & rhs)
{
  return lhs.m == rhs.m;
}
