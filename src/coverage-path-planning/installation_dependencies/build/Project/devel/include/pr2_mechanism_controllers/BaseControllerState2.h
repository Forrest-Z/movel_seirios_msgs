...
bool operator==(const ::pr2_mechanism_controllers::BaseControllerState2_<ContainerAllocator1> & lhs, const ::pr2_mechanism_controllers::BaseControllerState2_<ContainerAllocator2> & rhs)
{
  return lhs.command == rhs.command &&
    lhs.joint_command == rhs.joint_command &&
    lhs.joint_error == rhs.joint_error &&
    lhs.joint_velocity_commanded == rhs.joint_velocity_commanded &&
    lhs.joint_velocity_measured == rhs.joint_velocity_measured &&
    lhs.joint_effort_measured == rhs.joint_effort_measured &&
    lhs.joint_effort_commanded == rhs.joint_effort_commanded &&
    lhs.joint_effort_error == rhs.joint_effort_error &&
