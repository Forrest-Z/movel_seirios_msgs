...
bool operator==(const ::pr2_mechanism_controllers::BaseControllerState_<ContainerAllocator1> & lhs, const ::pr2_mechanism_controllers::BaseControllerState_<ContainerAllocator2> & rhs)
{
