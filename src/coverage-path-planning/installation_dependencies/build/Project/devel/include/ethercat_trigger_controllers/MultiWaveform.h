...
bool operator==(const ::ethercat_trigger_controllers::MultiWaveform_<ContainerAllocator1> & lhs, const ::ethercat_trigger_controllers::MultiWaveform_<ContainerAllocator2> & rhs)
{
  return lhs.period == rhs.period &&
    lhs.zero_offset == rhs.zero_offset &&
