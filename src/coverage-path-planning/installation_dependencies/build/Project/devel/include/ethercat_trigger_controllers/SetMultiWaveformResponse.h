...
bool operator==(const ::ethercat_trigger_controllers::SetMultiWaveformResponse_<ContainerAllocator1> & lhs, const ::ethercat_trigger_controllers::SetMultiWaveformResponse_<ContainerAllocator2> & rhs)
{
