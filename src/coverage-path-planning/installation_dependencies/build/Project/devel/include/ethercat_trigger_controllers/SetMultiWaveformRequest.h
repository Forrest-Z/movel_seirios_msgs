...
bool operator==(const ::ethercat_trigger_controllers::SetMultiWaveformRequest_<ContainerAllocator1> & lhs, const ::ethercat_trigger_controllers::SetMultiWaveformRequest_<ContainerAllocator2> & rhs)
{
  return lhs.waveform == rhs.waveform;
}
