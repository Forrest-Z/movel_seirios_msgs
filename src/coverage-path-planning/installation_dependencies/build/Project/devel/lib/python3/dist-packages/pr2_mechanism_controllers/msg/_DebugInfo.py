...
"""autogenerated by genpy from pr2_mechanism_controllers/DebugInfo.msg. Do not edit."""
import codecs
import sys
...
class DebugInfo(genpy.Message):
  ...
  _type = "pr2_mechanism_controllers/DebugInfo"
...
float64 residual"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.timing))
      _x = self
      buff.write(_get_struct_iBd().pack(_x.sequence, _x.input_valid, _x.residual))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.timing = s.unpack(str[start:end])
      _x = self
      start = end
      end += 13
      (_x.sequence, _x.input_valid, _x.residual,) = _get_struct_iBd().unpack(str[start:end])
