...
"""autogenerated by genpy from cob_actions/SetFloatActionResult.msg. Do not edit."""
import codecs
import sys
...
class SetFloatActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "cob_actions/SetFloatActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_actions/SetFloatResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetFloatActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cob_actions.msg.SetFloatResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cob_actions.msg.SetFloatResult()
