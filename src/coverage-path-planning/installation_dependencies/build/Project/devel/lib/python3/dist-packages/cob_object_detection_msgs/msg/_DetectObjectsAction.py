...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.object_name.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.object_list.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
