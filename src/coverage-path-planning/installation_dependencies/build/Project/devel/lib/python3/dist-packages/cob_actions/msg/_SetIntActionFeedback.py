...
"""autogenerated by genpy from cob_actions/SetIntActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SetIntActionFeedback(genpy.Message):
  _md5sum = "c174906940145c775f10875f0919664b"
  _type = "cob_actions/SetIntActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cob_actions/SetIntFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetIntActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cob_actions.msg.SetIntFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cob_actions.msg.SetIntFeedback()
