...
echo_and_run cd "/home/ryan/seirios-ros/src/movel_planning/coverage-path-planning/installation_dependencies/src/pr2_mechanism/pr2_controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ryan/seirios-ros/src/movel_planning/coverage-path-planning/installation_dependencies/src/pr2_mechanism/pr2_controller_manager/setup.py" \
     \
    build --build-base "/home/ryan/seirios-ros/src/movel_planning/coverage-path-planning/installation_dependencies/build/Project/pr2_mechanism/pr2_controller_manager" \
    install \
    --root="${DESTDIR-/}" \
