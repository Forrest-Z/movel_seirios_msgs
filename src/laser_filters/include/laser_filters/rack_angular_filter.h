...
#include <laser_filters/RackAngularFilterUpdate.h>
...
private:
  ...
  bool onUpdateParam(laser_filters::RackAngularFilterUpdateRequest &req, laser_filters::RackAngularFilterUpdateResponse &res);
