#ifndef KUDAN_SLAM_HANDLER_H
#define KUDAN_SLAM_HANDLER_H
...
{
class KudanSlamHandler : public task_supervisor::TaskHandler
{
private:
  /**
  ...
  // Interal vars
  std::string path_;
  unsigned int kudan_slam_launch_id_ = 0;
  bool saved_ = false;
  std::string p_map_name_;
  std::string map_name_nav_;
  ...
  std::string p_kudan_slam_launch_package_;
  std::string p_kudan_slam_launch_;
  std::string p_kudan_slam_launch_nodes_;
