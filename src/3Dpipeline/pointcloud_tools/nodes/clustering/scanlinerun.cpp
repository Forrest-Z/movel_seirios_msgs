...
*/
[[deprecated("Not useful in my case.")]] int ScanLineRun::smart_idx_(int local_idx, int n_i, int n_j,
                                                                     bool inverse = false)
{
  if (inverse == false)
  {
...
*/
visualization_msgs::Marker mark_cluster(pcl::PointCloud<SLRPointXYZIRL>::Ptr cloud_cluster, std::string ns, int id,
