#ifndef RTABMAP_PCL_SLAM_HANDLER_H
#define RTABMAP_PCL_SLAM_HANDLER_H
...
{
class RtabmapPclSlamHandler : public task_supervisor::TaskHandler
{
private:
  /**
  ...
  // Interal vars
  std::string path_;
  unsigned int rtabmap_pcl_slam_launch_id_ = 0;
  bool saved_ = false;
