...
## Nodes
- mongo_bridge: Node to get zone data of selected map from MongoDB database
...
## Services
- [mongo_bridge] mongo_bridge/get_speed_zones: Service to get speed zone data from MongoDB database with map name as input
...
## Debug
- Published topic: /speed_limit_zones/display
    - Display polygons of zones in rviz
    - Set "debug" arg to true in speed_limit_zone.launch to enable