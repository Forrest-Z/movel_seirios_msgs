...
public:
  ...
  *****************************************************************/
   ...
   * control : input
  *****************************************************************/
  void predict( const VectorM& control, float lin, float ang, double difftime ){
    ...
    if ((lin == 0.0) && (ang != 0.0)){
      ...
      ang = double(ang);
      rotation(0, 0) = double(cos(ang*difftime));
      rotation(0, 1) = -double(sin(ang*difftime));
      rotation(1, 0) = double(sin(ang*difftime));
      rotation(1, 1) = double(cos(ang*difftime));
      rotation(2, 2) = 1.0;
      rotation(3, 3) = 1.0;
      rotation(4, 4) = 1.0;
      rotation(5, 5) = 1.0;
  ...
  *****************************************************************/
  void correct( const VectorK& measurement ){
    ...
    //ROS_INFO_STREAM("mean just after measurment step: " << mean);
  }
