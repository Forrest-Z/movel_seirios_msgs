...
public:
     ...
     * @param do_merge 
     */
    LIOF(int radius_threshold = 32, int final_radius = 8, float low_angle = 1.0, float high_angle = 2.0, int length_threshold = 25, float distance_threshold = 1.41421356f, double canny_th1 = 5.0, double canny_th2 = 20.0, int canny_aperture_size = 3, bool do_merge = false);
