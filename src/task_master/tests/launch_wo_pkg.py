...
def main():
    ...
    error_prone_msg = {'Timeout': 0.1, 'Pk': None, 'Executable': None, 'Params': None, 'Args': None, 'Launchfile':'/home/ryan/seirios_ros/install/broadcast_pose/share/broadcast_pose/launch/broadcast_pose.launch'}
    error_free_msg = {'Timeout': 0.1, 'Pkg': None, 'Executable': None, 'Params': None, 'Args': None, 'Launchfile':'/home/ryan/seirios_ros/install/broadcast_pose/share/broadcast_pose/launch/broadcast_pose.launch'}
