...
public:
  ...
  std::vector<double> calculateHistogram(const std::vector<double>& data_x, const std::vector<double>& data_y,
                                         const boost::array<double, 2>& point);
  std::vector<double> calculateLineHistogram(const std::vector<double>& data_x, const std::vector<double>& data_y,
                                             Line& line);
  void setPointsHistogram(const std::vector<double>& data_x, const std::vector<double>& data_y,
                          std::vector<Keypoint>& points);
  void setLinesHistogram(const std::vector<double>& data_x, const std::vector<double>& data_y,
