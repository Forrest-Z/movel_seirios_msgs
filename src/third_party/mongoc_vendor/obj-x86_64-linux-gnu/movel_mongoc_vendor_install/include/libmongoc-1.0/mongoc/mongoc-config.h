...
#define MONGOC_USER_SET_CFLAGS "-g -O2 -fdebug-prefix-map=/home/ryan/seirios_ros/src/third_party/mongoc_vendor=. -fstack-protector-strong -Wformat -Werror=format-security"
