...
// Diagnostics support
////////////////////////////////////////////////////////////////////
#include <movel_hasp_vendor/haspdiag.h>
...
public:
  ...
  static haspStatus getInfo(const char* pszQuery, const char* pszFormat, hasp_vendor_code_t vendorCode,
                            ChaspInfo& info);
  ...
  haspStatus readFile(hasp_fileid_t fileId, hasp_size_t ulOffset, unsigned char* pData, hasp_size_t ulSize) const;
  haspStatus setIdleTime(hasp_u16_t nIdleTime) const;
  std::string toString() const;
  haspStatus writeFile(hasp_fileid_t fileId, hasp_size_t ulOffset, const unsigned char* pData,
...
protected:
  ...
  // Implementation
public:
  static void decode(const std::string& source, std::vector<unsigned char>& dest) throw();
  static void encode(const std::vector<unsigned char>& source, std::string& dest) throw();
