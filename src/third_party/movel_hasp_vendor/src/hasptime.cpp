...
hasp_time_t ChaspTimeHelper::toTime() const
{
  ...
  if (!HASP_SUCCEEDED(hasp_datetime_to_hasptime(m_nDay, m_nMonth, m_nYear, m_nHour, m_nMinute, m_nSecond, &time)))
    time = 0;
...
{
  if (!HASP_SUCCEEDED(hasp_hasptime_to_datetime(time, &m_nDay, &m_nMonth, &m_nYear, &m_nHour, &m_nMinute, &m_nSecond)))
  {
    memset(this, 0x00, sizeof(*this));
    return false;
  }
...
////////////////////////////////////////////////////////////////////
ChaspTime::ChaspTime(hasp_time_t time /* = 0 */) : m_time(time)
{
}
...
////////////////////////////////////////////////////////////////////
ChaspTime::ChaspTime(unsigned int nYear, unsigned int nMonth, unsigned int nDay, unsigned int nHour,
