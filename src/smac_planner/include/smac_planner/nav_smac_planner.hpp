...
#include <smac_planner/SmacPlannerConfig.h>
...
protected:
  std::unique_ptr<AStarAlgorithm<
      ...
      GridCollisionChecker<
        smac_planner::FootprintCollisionChecker<costmap_2d::Costmap2D *>, costmap_2d::Costmap2D,
        smac_planner::Footprint>,
      costmap_2d::Costmap2D, smac_planner::Footprint>>
  _a_star;
  ...
  std::unique_ptr<ros::Publisher> _plan_publisher;
...
private:
  ...
  dynamic_reconfigure::Server<smac_planner::SmacPlannerConfig> *dsrv_;
  void reconfigureCB(smac_planner::SmacPlannerConfig &config, uint32_t level);
};
