...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::ServiceClient client_update_profile = nh.serviceClient<movel_laser_filters::ProfileUpdate>("LaserscanMultiFilterProfileUpdate");
    movel_laser_filters::ProfileUpdate profile_update_srv;
