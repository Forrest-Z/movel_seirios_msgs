...
#include <movel_laser_filters/BoxArrayFilterConfig.h>
...
typedef dynamic_reconfigure::Client<movel_laser_filters::AngularBoundsFilterConfig> dyncfg_client_angle;
typedef dynamic_reconfigure::Client<movel_laser_filters::AngularBoundsFilterInPlaceConfig> dyncfg_client_angleinplace;
typedef dynamic_reconfigure::Client<movel_laser_filters::BoxFilterConfig> dyncfg_client_box;
typedef dynamic_reconfigure::Client<movel_laser_filters::BoxArrayFilterConfig> dyncfg_client_boxarray;
typedef dynamic_reconfigure::Client<movel_laser_filters::FootprintFilterConfig> dyncfg_client_footprint;
typedef dynamic_reconfigure::Client<movel_laser_filters::IntensityFilterConfig> dyncfg_client_intensity;
typedef dynamic_reconfigure::Client<movel_laser_filters::PolygonFilterConfig> dyncfg_client_polygon;
typedef dynamic_reconfigure::Client<movel_laser_filters::RangeFilterConfig> dyncfg_client_range;
typedef dynamic_reconfigure::Client<movel_laser_filters::ScanShadowsFilterConfig> dyncfg_client_scanshadows;
typedef dynamic_reconfigure::Client<movel_laser_filters::SpeckleFilterConfig> dyncfg_client_speckle;
...
private:
     ...
     */
    // std::shared_ptr<dynamic_reconfigure::Client<movel_laser_filters::AngularBoundsFilterConfig>> dyn_client_angle_; 
     ...
     */
    movel_laser_filters::AngularBoundsFilterConfig cfg_angle_;
    movel_laser_filters::AngularBoundsFilterInPlaceConfig cfg_angleinplace_;
    movel_laser_filters::BoxFilterConfig cfg_box_;
    movel_laser_filters::BoxArrayFilterConfig cfg_boxarray_;
    movel_laser_filters::FootprintFilterConfig cfg_footprint_;
    movel_laser_filters::IntensityFilterConfig cfg_intensity_;
    movel_laser_filters::PolygonFilterConfig cfg_polygon_;
    movel_laser_filters::RangeFilterConfig cfg_range_;
    movel_laser_filters::ScanShadowsFilterConfig cfg_scanshadows_;
    movel_laser_filters::SpeckleFilterConfig cfg_speckle_; 
};
    ...
    if (ros::param::get(node_name_, config_xml))
    {
        ...
        for (int i=0; i < num_scan_topics_; i++) 
        {
            ...
            for (int j = 0; j < config[input_scan_topics_[i]][profile_id]["scan_filter_chain"].size(); j++) 
            {
               ...
               else if (filter_type == "movel_laser_filters/LaserScanBoxArrayFilter"){
...
bool LaserScanProfileUpdateServer::onProfileUpdate(movel_laser_filters::ProfileUpdate::Request &req, movel_laser_filters::ProfileUpdate::Response &res)
{
