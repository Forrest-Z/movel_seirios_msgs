...
#include <movel_laser_filters/RackFilterUpdate.h>
...
private:
  ...
  bool onUpdateParam(movel_laser_filters::RackFilterUpdateRequest &req, movel_laser_filters::RackFilterUpdateResponse &res);
