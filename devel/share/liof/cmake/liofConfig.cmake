...
if(liof_CONFIG_INCLUDED)
  return()
endif()
set(liof_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(liof_SOURCE_PREFIX /home/movel/seirios_ws/src/liof)
  set(liof_DEVEL_PREFIX /home/movel/seirios_ws/devel)
  set(liof_INSTALL_PREFIX "")
  set(liof_PREFIX ${liof_DEVEL_PREFIX})
else()
  set(liof_SOURCE_PREFIX "")
  set(liof_DEVEL_PREFIX "")
  set(liof_INSTALL_PREFIX /home/movel/seirios_ws/install)
  set(liof_PREFIX ${liof_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'liof' is deprecated")
...
set(liof_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/movel/seirios_ws/src/liof/include;/usr/include/opencv4 " STREQUAL " ")
  set(liof_INCLUDE_DIRS "")
  set(_include_dirs "/home/movel/seirios_ws/src/liof/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'movelai <movelai@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${liof_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'liof' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'liof' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/movel/seirios_ws/src/liof/${idir}'.  ${_report}")
    endif()
    _list_append_unique(liof_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND liof_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND liof_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT liof_NUM_DUMMY_TARGETS)
      set(liof_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::liof::wrapped-linker-option${liof_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR liof_NUM_DUMMY_TARGETS "${liof_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::liof::wrapped-linker-option${liof_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND liof_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(liof_LIBRARY_DIRS ${lib_path})
      list(APPEND liof_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'liof'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND liof_LIBRARIES ${lib})
    endif()
  endif()
...
set(liof_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${liof_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 liof_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${liof_dep}_FOUND)
      find_package(${liof_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${liof_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(liof_INCLUDE_DIRS ${${liof_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(liof_LIBRARIES ${liof_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${liof_dep}_LIBRARIES})
  _list_append_deduplicate(liof_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(liof_LIBRARIES ${liof_LIBRARIES})

  _list_append_unique(liof_LIBRARY_DIRS ${${liof_dep}_LIBRARY_DIRS})
  list(APPEND liof_EXPORTED_TARGETS ${${liof_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${liof_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
