...
if("TRUE" STREQUAL "TRUE")
  set(human_detection_SOURCE_PREFIX /home/movel/sirios_test_ws/src/human_detection)
  set(human_detection_DEVEL_PREFIX /home/movel/sirios_test_ws/devel)
  ...
  set(human_detection_INSTALL_PREFIX /home/movel/sirios_test_ws/install)
...
if(NOT "/home/movel/sirios_test_ws/devel/include;/home/movel/sirios_test_ws/src/human_detection/include " STREQUAL " ")
  set(human_detection_INCLUDE_DIRS "")
  set(_include_dirs "/home/movel/sirios_test_ws/devel/include;/home/movel/sirios_test_ws/src/human_detection/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'human_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/movel/sirios_test_ws/src/human_detection/${idir}'.  ${_report}")
    endif()
    _list_append_unique(human_detection_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "human_detection")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT human_detection_NUM_DUMMY_TARGETS)
      set(human_detection_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::human_detection::wrapped-linker-option${human_detection_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR human_detection_NUM_DUMMY_TARGETS "${human_detection_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::human_detection::wrapped-linker-option${human_detection_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND human_detection_LIBRARIES "${interface_target_name}")
...
set(human_detection_EXPORTED_TARGETS "human_detection_gencfg;human_detection_generate_messages_cpp;human_detection_generate_messages_eus;human_detection_generate_messages_lisp;human_detection_generate_messages_nodejs;human_detection_generate_messages_py")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(human_detection_EXPORTED_TARGETS ${${human_detection_dep}_EXPORTED_TARGETS})
endforeach()
