...
if(map_merge_CONFIG_INCLUDED)
  return()
endif()
set(map_merge_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(map_merge_SOURCE_PREFIX /home/movel/sirios_test_ws/src/map_merge)
  set(map_merge_DEVEL_PREFIX /home/movel/sirios_test_ws/devel)
  set(map_merge_INSTALL_PREFIX "")
  set(map_merge_PREFIX ${map_merge_DEVEL_PREFIX})
else()
  set(map_merge_SOURCE_PREFIX "")
  set(map_merge_DEVEL_PREFIX "")
  set(map_merge_INSTALL_PREFIX /home/movel/sirios_test_ws/install)
  set(map_merge_PREFIX ${map_merge_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'map_merge' is deprecated")
...
if(NOT "/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${map_merge_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_merge' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/movel/sirios_test_ws/src/map_merge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(map_merge_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND map_merge_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND map_merge_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT map_merge_NUM_DUMMY_TARGETS)
      set(map_merge_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::map_merge::wrapped-linker-option${map_merge_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR map_merge_NUM_DUMMY_TARGETS "${map_merge_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::map_merge::wrapped-linker-option${map_merge_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND map_merge_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(map_merge_LIBRARY_DIRS ${lib_path})
      list(APPEND map_merge_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'map_merge'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND map_merge_LIBRARIES ${lib})
    endif()
  endif()
...
set(depends "geometry_msgs;map_msgs;nav_msgs;roscpp;ros_utils;tf2_geometry_msgs;tf2")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 map_merge_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${map_merge_dep}_FOUND)
      find_package(${map_merge_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${map_merge_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(map_merge_INCLUDE_DIRS ${${map_merge_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(map_merge_LIBRARIES ${map_merge_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${map_merge_dep}_LIBRARIES})
  _list_append_deduplicate(map_merge_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(map_merge_LIBRARIES ${map_merge_LIBRARIES})

  _list_append_unique(map_merge_LIBRARY_DIRS ${${map_merge_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(map_merge_EXPORTED_TARGETS ${${map_merge_dep}_EXPORTED_TARGETS})
endforeach()
